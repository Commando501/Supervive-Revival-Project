...
| 4 | **Does guarding the catalog scan remove the 15–45 s menu-route death class?** | SEH/VEH or re-`VirtualQuery` per page in `FindCatalogManagers_first`; 11-record baseline to test against. | one-line change |
