...
enum asEObjTypeFlags
{
	...
	// Below asOBJ_APP_ flags are no longer used, since we do not support native calling convention anymore
	asOBJ_APP_CLASS                  = 0,
	asOBJ_APP_CLASS_CONSTRUCTOR      = 0,
	asOBJ_APP_CLASS_DESTRUCTOR       = 0,
	...
	asOBJ_DISALLOW_MEMBER            = (1<<8),
	asOBJ_DISALLOW_LOCAL_VALUE       = (1<<9),
};
...
struct asFunctionCaller
{
	...
	constexpr asFunctionCaller() : FunctionCaller(nullptr), type(0) {}
	constexpr asFunctionCaller(nullptr_t) : FunctionCaller(nullptr), type(0) {}
	constexpr asFunctionCaller(FunctionCallerPtr InFunctionCaller) : FunctionCaller(InFunctionCaller), type(1) {}
	constexpr asFunctionCaller(MethodCallerPtr InMethodCaller) : MethodCaller(InMethodCaller), type(2) {}

	constexpr bool IsBound() const { return MethodCaller != nullptr; }
};
...
enum asEBCInstr
{
	...
	asBC_RetInfo		= 214,
	asBC_PshVMemObj		= 215,
	asBC_PshThisMemObj		= 216,
	asBC_PshVMemRef		= 217,
	asBC_PshThisMemRef		= 218,
	asBC_PSFVMemRef		= 219,
...
const asSBCInfo asBCInfo[256] =
{
	...
	asBCINFO(RetInfo,		DW_ARG,			0),
	asBCINFO(PshVMemObj,		rW_W_DW_ARG,		AS_PTR_SIZE),
	asBCINFO(PshThisMemObj,		W_DW_ARG,			AS_PTR_SIZE),
	asBCINFO(PshVMemRef,		rW_W_DW_ARG,		AS_PTR_SIZE),
	asBCINFO(PshThisMemRef,		W_DW_ARG,			AS_PTR_SIZE),
	asBCINFO(PSFVMemRef,		rW_W_DW_ARG,		AS_PTR_SIZE),
